<template>
        <div title="Search with your voice" @click="startListening"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
...
const startListening = () => {
        ...
        annyang.addCallback('result', (phrases: string[]) => {
                // this.transcription = phrases[0];
                store.searchItem = phrases[0]
                annyang.abort();
        });
}
